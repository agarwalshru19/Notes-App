...
useEffect(() => {
  ...
  const getAllNotes = async () => {
    try {
      const res = await axios.get("https://notes-app-backendd-09i7.onrender.com/api/note/all", {
  ...
  const handleDelete = async (note) => {
    ...
    try {
      const res = await axios.delete(
        `https://notes-app-backendd-09i7.onrender.com/api/note/delete/${noteId}`,
        { withCredentials: true }
      );
      if (res.data.success === false) {
  ...
  const onSearchNote = async (query) => {
    try {
      const res = await axios.get("https://notes-app-backendd-09i7.onrender.com/api/note/search", {
        params: { query },
        withCredentials: true,
      });
  ...
  const handlePin = async (note) => {
    ...
    try {
      const res = await axios.put(
        `https://notes-app-backendd-09i7.onrender.com/api/note/update-pin/${noteId}`,
